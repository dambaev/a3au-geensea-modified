...
if( isNil "traderX") exitWith {
    [localize "STR_A3A_Base_sellVehicle_header"
      , localize "STR_A3A_Base_sellVehicle_err0.1"
      ] remoteExecCall ["SCRT_fnc_misc_deniedHint",_player];
};
private _isNearTrader = _veh distanceSqr (position traderX) <= (100 * 100);
if (!_isNearTrader ) exitWith {
...
[ _costs * 0.9 ] remoteExec [ "A3A_fnc_resourcesPlayer", _player];
[ _hr, _costs * 0.1] call A3A_fnc_resourcesFIA;
